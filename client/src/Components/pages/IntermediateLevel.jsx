...
const IntermediateLevel = () => {
  ...
  const rounds = [
    {
      clue: "A fruit known as the king of fruits in Asia",
      options: ["Mango", "Durian", "Papaya", "Lychee", "Banana", "Jackfruit"],
      answer: "Durian",
    },
    {
      clue: "A fruit high in vitamin C, often green or purple",
      options: ["Grapes", "Kiwi", "Orange", "Guava", "Lime", "Starfruit"],
      answer: "Kiwi",
    },
    {
      clue: "A tropical fruit with spiky skin and sweet yellow flesh",
      options: ["Pineapple", "Mango", "Jackfruit", "Papaya", "Lychee", "Banana"],
      answer: "Pineapple",
    },
    {
      clue: "Small red berries, often used in pies and jams",
      options: ["Strawberry", "Raspberry", "Cranberry", "Cherry", "Gooseberry", "Lingonberry"],
      answer: "Raspberry",
    },
    {
      clue: "A fruit often confused with vegetables, purple outside, green inside",
      options: ["Eggplant", "Plum", "Passionfruit", "Avocado", "Figs", "Okra"],
      answer: "Passionfruit",
    },
    {
      clue: "A yellow tropical fruit that's curved and sweet",
      options: ["Banana", "Plantain", "Mango", "Papaya", "Pineapple", "Durian"],
      answer: "Banana",
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="mt-2 text-xl font-bold text-red-600 animate-ping" style={{ fontFamily: "'Comic Neue', cursive" }}>
          ⏱ {timer}s
        </div>
      </motion.div>
      ...
      <div className="text-center mb-8 px-4">
        <p className="text-xl font-bold text-yellow-200 tracking-wide animate-pulse">Round {currentRound + 1}/6</p>
      ...
      <button
        onClick={() => navigate("/levels")}
        className="mb-8 bg-green-600 px-6 py-3 rounded-xl font-bold hover:bg-green-700 transition" style={{fontFamily: "'Press Start 2P', cursive"}}
      >
        ⬅ Back to Levels
      </button>
    </div>
